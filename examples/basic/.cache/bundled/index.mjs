...
var pages_default = (state) => {
  return /* @__PURE__ */ jsx(
    ...
    /* @__PURE__ */ jsx('p', null, 'bbbb'),
    /* @__PURE__ */ jsx('p', null, state.text),
    /* @__PURE__ */ jsx('p', null, state.test),
    /* @__PURE__ */ jsx(CustomComponent, null, 'component'),
    /* @__PURE__ */ jsx(
      'p',
      null,
      'Server side prop ',
...
export { pages_default as default, getInitialState, getServerSideState }
